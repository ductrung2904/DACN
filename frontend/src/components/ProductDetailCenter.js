...
function ProductDetailCenter({ aut_id, aut_name, eva_count, eva_rating, book_name, book_sale, book_price }) {
    const renderRating = () => {
        if (!eva_count) {
